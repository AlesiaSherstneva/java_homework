...
public class Exercise12 {
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter fileWriter = new FileWriter("test.txt")) {
            fileWriter.write("""
                    "Интересно, в чем придет профессор на лекцию в этот раз?" - думала Марина Рубинова. Профессор пришел в тренировочном костюме и в кедах. Он был суров и деловит. Он сразу спросил:
                    - Где батут, Марина?
                    ...
                    Наверное, летать над батутом трудно. Профессор все время переворачивался в воздухе и норовил опуститься в сетку головой, и на его лице проступали мелкие квадраты от сетки.""");
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        System.out.println("Прочитанный текст:\n" + readingText);
